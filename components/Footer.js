        ...
        <div className="grid grid-cols-4 gap-8">
          <div className="col-span-1 space-y-8">
            ...
            <p className="text-gray-500">
              AutoRide has provided car services in Oakland area since 2007.
              What started as a small company has grown into a premier limousine
          ...
          <div className="col-span-1 space-y-8">
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex flex-row items-center space-x-4">
                ...
                <p className="text-gray-500">2507 Parker Boulevard, Oakland</p>
              </div>
              <div className="flex flex-row items-center space-x-4">
